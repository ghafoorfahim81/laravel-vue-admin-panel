<template>
            <!--begin datatable  -->
            <div class="row pb-1 ">
                <div class="col-sm-6 col-md-6 col-4 form-inline">
...
<!--                        <label for="show">show &nbsp</label>-->
                ...
                <div class="col-sm-6 col-md-3 col offset-3">
                    <div class="form-group">
                        <input v-model="filter" @input="getData"  type="text" class="form-control w-full form-control-sm"
                               placeholder="Search" aria-controls="datatable" ref="filter">
                               
                    </div>
                </div>
                <div class=" table-responsive mb-0 shadow-md">
                    <table id="tech-companies-1" class="table table-striped bordered">
                    <slot name="thead">
                        <thead class="thead">
                        <tr>
                            ...
                            <th v-for="(col,index) in columns" :key="index"
                                ...
                                <template v-if="col.sort===true">
                                    <i class="fas fa-long-arrow-alt-down"
                                       :style="{color:(getColumnSortClass(index).direction==='asc' && activeSortColumn===col.name)?'#4d94ff':'#c2c2a3'}"
                                       style="margin-right:-1.5px;margin-left:-1.5px;"></i>
                                    <i class="fas fa-long-arrow-alt-up"
                                       :style="{color:(getColumnSortClass(index).direction==='desc' && activeSortColumn===col.name)?'#4d94ff':'#c2c2a3'}"
                                       style="margin-right:-1.5px;margin-left:-1.5px;"></i>
                                </template>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            dataPerPage(){
                // this.perPage = this.userDataPerPage;
                console.log("this.userDataPerPage",this.userDataPerPage);
        ...
        methods: {
            ...
            setUrl(sendRequest = true) {
                let url = this.$parent.url;
                    console.log('uuuuuuuuuuuuurl',url);
                ...
                // console.log('url is ',url+"search_keyword="+this.filter)
                if (sendRequest) {
