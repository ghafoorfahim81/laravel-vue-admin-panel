            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-5">
                    <div class="footer_payment">
                        <ul>
                            <li><a href="#"><img src="{{ url('assets/frontend/img/icon/paypal1.jpg')}}'" alt=""></a></li>
                            <li><a href="#"><img src="{{ url('assets/frontend/img/icon/paypal2.jpg')}}" alt=""></a></li>
                            <li><a href="#"><img src="{{ url('assets/frontend/img/icon/paypal3.jpg')}}" alt=""></a></li>
                            <li><a href="#"><img src="{{ url('assets/frontend/img/icon/paypal4.jpg')}}" alt=""></a></li>
                        </ul>
                    </div>
                </div>
            </div>
